...
const InputField = ({
    ...
    keyboardType, secureTextEntry, error, rightIcon, onRightIconPress
}) => (
    <View style={{ marginBottom: 4 }}>
        <View style={[styles.inputWrapper, error && styles.inputWrapperError]}>
            ...
            />
            {rightIcon && (
                <Pressable onPress={onRightIconPress} style={{ paddingLeft: 8, paddingRight: 4 }}>
...
const TeacherLogin = () => {
    ...
    const validate = () => {
        ...
        else if (!email.includes('@')) e.email = 'Please enter a valid institution email';
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            clearLoginData();
            router.replace('/teachers/teacher_dashboard');
        } catch (error) {
                ...
                <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    ...
                    <Animated.View entering={FadeInDown.duration(600).delay(200)} style={styles.card}>
                            ...
                            <View style={styles.bioRow}>
                                ...
                                <Pressable 
                                    ...
                                    onPress={() => router.push({
                                        ...
                                        params: { role: 'teacher', mode: 'verify', returnTo: '/teachers/' }
                                    })}
                                >
                        ...
                        <View style={styles.signupRow}>
                            <Text style={styles.signupText}>New teacher? </Text>
                            <Pressable onPress={() => router.replace('/teachers/teachers_signup')}>
...
const styles = StyleSheet.create({
    ...
    inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: BG, borderRadius: 12, borderWidth: 1, borderColor: 'transparent', paddingHorizontal: 14, height: 52 },
    inputWrapperError: { borderColor: ERROR_COLOR, backgroundColor: '#FEF2F2' },
